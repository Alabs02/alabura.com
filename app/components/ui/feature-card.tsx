...
export const FeatureCard = ({
  ...
  return (
    <div
      className={cn(
        "w-full h-full p-5 xl:p-8 rounded-xl border border-zinc-400/20 bg-[rgba(40,40,40,0.70)] shadow-[2px_4px_16px_0px_rgba(248,248,248,0.06)_inset] group",
        className
      )}
    >
      {children}
...
export const FeatureContainer = ({
  ...
  return (
    ...
    shadow-[0px_0px_8px_0px_rgba(248,248,248,0.3)_inset,0px_32px_24px_-16px_rgba(0,0,0,0.40)]
    `,
        className
      )}
    >
